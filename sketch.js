...
var score;
var p5,s1,s2,sl1,sl2,sl3,sl4,sl5,b1,b2,b3,b4,b5,b21,b22,b23,b24,b31,b32,b34,b35,b36,b37,bs0,bs1,bs2,bs3,bs4;
function preload()
{
...
function setup() {
  ...
  p5 = new rectangle(400,550,500,20);
...
function detectollision(lball,lplat){

  ballBody=lball.body.position;
  platBody=lplat.body.position;
  var distance=dist(ballBody.x, ballBody.y, platBody.x, platBody.y)
   console.log(distance)
  if(distance<=lball.r+lplat.r)
    {
      console.log(distance);
  	  Matter.Body.setStatic(lplat.body,false);
    }
